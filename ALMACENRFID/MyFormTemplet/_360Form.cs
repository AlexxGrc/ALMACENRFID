...
namespace ALMACENRFID.MyFormTemplet
{
    ...
    public partial class _360Form : BaseForm
    {
        ...
        /// 标题栏菜单按钮图片
        /// </summary>
        private Image _titleBarMenuImage = AssemblyHelper.GetImage("\\_360\\SysButton\\title_bar_menu.png");
        ...
        /// 系统控制按钮与右边框之间的距离
        /// </summary>
        [Description("La distancia entre el botón de control del sistema y el borde derecho.")]
